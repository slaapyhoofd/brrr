...
export const Help = ({ open, setOpen }: IHelpProps) => (
  <dialog id="modal-help" open={open}>
    <article>
      ...
      <p>
        <b>Welcome to the incredible world of BRRRR-NFC! </b>I was brought to life at 755550 by the
        ...
        <br />
        As the very first web version in bitcoinland I will help you to <b>batchwise</b> set up
        ...
        <br />
        Notes: <br />
        - The cards are not closed, which allows a cardholder to overwrite it in favour of a wallet
        on his own node. Thats the way. <br />
        - To prevent trouble with AML rules you may not sell the cards and let them expire at a
        certain time after your event. <br />
        - NFCCards with NTAG 216 can carry just 1 written link which usually is the one to pay with.
        But that´s not enough, right? To be able to refill the card or see the balance, NFC-BRRR can
        ...
        <br />
        Machines set up, that your customers can pay with bitcoin via Lightning? Let´s get your
        wallets and stickers ready and BRRRR some cards!
      </p>

      <h3>LNBits</h3>
      <p>
        LNbits is a godswork open source accounting-app built by various wonderful people and that
        has lots of extensions and helpful features for developers. You can run LNbits as a separate
        ...
        You can choose between links to
        <br />
      ...
      <p>
        ...
        <br />
        Have a look at some ideas from builders around the globe at{' '}
